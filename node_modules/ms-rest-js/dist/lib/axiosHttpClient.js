...
var tough = tslib_1.__importStar(require("tough-cookie"));
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (httpRequest.formData) {
                            ...
                            requestForm_1 = new form_data_1.default();
                    ...
                    case 2:
                        ...
                        if (abortSignal && abortSignal.aborted) {
                            throw new restError_1.RestError("The request was aborted", restError_1.RestError.REQUEST_ABORTED_ERROR, undefined, httpRequest);
                        }
                    ...
                    case 5:
                        ...
                        if (err_1 instanceof axios_1.default.Cancel) {
                            throw new restError_1.RestError(err_1.message, restError_1.RestError.REQUEST_SEND_ERROR, undefined, httpRequest);
                        }
                        else {
                            axiosErr = err_1;
                            throw new restError_1.RestError(axiosErr.message, restError_1.RestError.REQUEST_SEND_ERROR, undefined, httpRequest);
                        }
                        return [3 /*break*/, 7];
                    case 6:
