...
function retry(policy, request, response, retryData, requestError) {
    ...
    if (!isAborted && shouldRetry(policy, response && response.status, retryData)) {
        ...
        var err = retryData.error ||
            new restError_1.RestError("Failed to send the request.", restError_1.RestError.REQUEST_SEND_ERROR, response && response.status, response && response.request, response);
