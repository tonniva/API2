...
var URLBuilder = /** @class */ (function () {
    ...
    URLBuilder.prototype.replaceAll = function (searchValue, replaceValue) {
        if (searchValue) {
            this.setScheme(utils_1.replaceAll(this.getScheme(), searchValue, replaceValue));
            this.setHost(utils_1.replaceAll(this.getHost(), searchValue, replaceValue));
            this.setPort(utils_1.replaceAll(this.getPort(), searchValue, replaceValue));
            this.setPath(utils_1.replaceAll(this.getPath(), searchValue, replaceValue));
            this.setQuery(utils_1.replaceAll(this.getQuery(), searchValue, replaceValue));
        }
    };
