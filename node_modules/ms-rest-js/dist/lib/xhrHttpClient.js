...
function rejectOnTerminalEvent(request, xhr, reject) {
    xhr.addEventListener("error", function () { return reject(new restError_1.RestError("Failed to send request to " + request.url, restError_1.RestError.REQUEST_SEND_ERROR, undefined, request)); });
    xhr.addEventListener("abort", function () { return reject(new restError_1.RestError("The request was aborted", restError_1.RestError.REQUEST_ABORTED_ERROR, undefined, request)); });
    xhr.addEventListener("timeout", function () { return reject(new restError_1.RestError("timeout of " + xhr.timeout + "ms exceeded", restError_1.RestError.REQUEST_SEND_ERROR, undefined, request)); });
}
